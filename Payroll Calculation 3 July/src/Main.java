...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        employees.add(new HourlyEmployee("Parvej","Shah Hourly 40+ hour","SSNIIHOurly",300.80,50));
        employees.add(new CommissionEmployee("Parvej","Shah Commission","SSNIIHOurly",300.50));
        ...
        for (Employee employee : employees) {
            if (employee instanceof BasePlusCommissionEmployee) {
                ((BasePlusCommissionEmployee) employee).increaseBaseSalary();
            }
        }
